function varargout = P300_Panel(varargin)
% P300_Panel MATLAB code for P300_Panel.fig
%      P300_Panel, by itself, creates a new P300_Panel or raises the existing
%      singleton*.
%
%      H = P300_Panel returns the handle to a new P300_Panel or the handle to
%      the existing singleton*.
%
%      P300_Panel('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in P300_Panel.M with the given input arguments.
%
%      P300_Panel('Property','Value',...) creates a new P300_Panel or raises the
%      existing singleton*.  Starting from the Left, property value pairs are
%      applied to the GUI before P300_Panel_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to P300_Panel_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help P300_Panel
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @P300_Panel_OpeningFcn, ...
                   'gui_OutputFcn',  @P300_Panel_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before P300_Panel is made visible.
function P300_Panel_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to P300_Panel (see VARARGIN)

% Choose default command line output for P300_Panel
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes P300_Panel wait for user response (see UIRESUME)
% uiwait(handles.P300_Panel);
            

% --- Outputs from this function are returned to the command line.
function varargout = P300_Panel_OutputFcn(hObject, eventdata, handles) 
...
%****************************** Two Monitors ******************************
set(handles.P300_Panel,'Units','pixels');
...
set(handles.P300_Panel,'OuterPosition',panel_pos);
%**************************************************************************

%****************************Objects Position******************************
% !!!!! 'Units' of all objects must be 'pixels'. !!!!!
position = get(handles.P300_Panel,'Position');
% x = position(1);
% y = position(2);
width = position(3);
height = position(4);
...
%     end
    ...
    switch i_block
        ...
        case 7
            ...
            set(hnd2,'backgroundcolor','g');
            m0=m0+250;
            fprintf(obj,['#0 P' num2str(m0) 'T1500'])
            pause(1.5);
            set(hnd2,'backgroundcolor','k');
        case 8
            y=2;
        ...
        case 14
            ...
            set(hnd2,'backgroundcolor','g');
            m3=m3+200;
            fprintf(obj,['#3 P' num2str(m3) 'T1500'])
            pause(1.5);
            set(hnd2,'backgroundcolor','k');
        case 15
            y=3;
        ...
        case 17
            ...
            set(hnd2,'backgroundcolor','g');
            m4=m4-1250;
            fprintf(obj,['#4 P' num2str(m4) 'T1500'])
            pause(1.5);
            set(hnd2,'backgroundcolor','k');
        case 18
            y=1;
            hnd2=findobj('tag', ['B',Commands{y}]);
            set(hnd2,'backgroundcolor','r');
            mode=0;
